      ...
      <div className='relative max-w-7xl z-10 mx-auto px-4 sm:px-6 lg:px-8'>
        <FadeIn delay={0}>
          <div className='text-center mb-12'>
            ...
            <h2 className='text-4xl lg:text-5xl text-white font-normal mb-4'>Featured Projects</h2>
            <p className='text-lg text-white/60 max-w-2xl mx-auto'>Showcasing my best work and achivements</p>
          </div>
        </FadeIn>
