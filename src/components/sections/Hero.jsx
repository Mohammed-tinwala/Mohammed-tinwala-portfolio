          ...
          <div className='text-left'>
            ...
            <FadeIn delay={100}>
              <h1 className='text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight'>
                Full Stake Developer Portfolio
              </h1>
            </FadeIn>

            <FadeIn delay={200}>
              <p className='text-lg text-white/70 max-w-[550px] mb-8'>
                Building modern, scalable full-stack applications with React.js, Node.js and cloud-ready technologies. Transforming ideas into reliable, user-focused digital solutions.
              </p>
            </FadeIn>
            ...
            <div className='relative'>
              <div className='relative overflow-hidden rounded-2xl aspect-8/9 max-w-[500px] ml-auto group'>
                ...
                <div className='relative rounded-2xl overflow-hidden m-[1px] h-[calc(100%-2px)]'>
                  <img
                    src="/images/developer-potrait3.png"
                ...
                <div className='absolute bottom-6 left-6 z-20'>
                  <FadeIn delay={500}>
                    <div className='flex items-center gap-4 bg-black/40 backdrop-blur-sm border border-white/10 rounded-full px-4 py-3'>
