...
const About = () => {
    ...
    const skills = [
        ...
        { name: 'Tailwind CSS', icon: SiTailwindcss, color: '#08B6D4' },
    ...
    return (
        <section id='about' className='relative py-20 bg-black overflow-hidden'>
            ...
            <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20'>
                    ...
                    <div className='flex flex-col gap-12'>
                        <div className='flex flex-col gap-8'>
                            ...
                            <FadeIn delay={100}>
                                <h2 className='text-4xl lg:text-5xl text-white font-normal leading-tight'>Crafting Digital Experience That Matter</h2>
                            </FadeIn>
                ...
                {/* Skills and Grid Section */}
                <FadeIn delay={500}>
                    <div className='flex flex-col items-center gap-8'>
                        <div className='text-center'>
                            <h3 className='text-2xl font-normal text-white mb-2'>Tech Expertise</h3>
                            <p className='text-sm text-white/60 mb-2'>Technologies i work with to built amazing products.</p>
                        </div>
