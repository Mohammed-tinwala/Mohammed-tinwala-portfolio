                ...
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return Icon ? (
                    <a
                      ...
                      aria-label={`Connect in ${platform}`}
                    >
                      <Icon className='w-5 h-5 text-white/60 group-hover:text-primary transition-colors duration-300' />
                      <div className='absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-xl transition-all duration-300 pointer-event-none' />
                    </a>
                  ) : null
                })}
              </div>
          ...
          <div className='pt-8 border-t border-white/10'>
            <div className='flex flex-col md:flex-row items-center justify-between gap-4'>
              ...
              <p className='flex items-center gap-2 text-white/50 text-sm'>
                Built with <Heart className='w-4 h-4 text-primary fill-primary animate-pulse' /> using React.js and Tailwind CSS.
              </p>
            </div>
          </div>
        </FadeIn>
